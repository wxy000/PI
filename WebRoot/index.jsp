 	...
 	var tanchu = {
		notice: function(){
			...
			layer.open({
				...
				,content: '<div style="padding: 50px; line-height: 22px; background-color: #393D49; color: #fff; font-weight: 300;">你知道吗？亲！<br>你不知道（调皮）<br><br>本站源码已上传至GitHub：<a href="http://github.com/wxy000/PI" target="_blank" style="color:red">http://github.com/wxy000/PI<br><br>这个项目是《Java Web开发》的课程设计，由于所使用的后端框架SSH以及前端UI框架LayUI是现学现卖的，所以多有不足，后期可能会继续完善。</div>'
				,success: function(layero){
					var btn = layero.find('.layui-layer-btn');
			    	btn.find('.layui-layer-btn0').attr({
			    		href: 'http://github.com/wxy000/PI'
			    		,target: '_blank'
			    	});
				}
			});
